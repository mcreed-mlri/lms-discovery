    ...
    <div className="hub-shell flex min-h-screen flex-col">
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        ...
        <div className="editorial-panel rounded-[var(--radius-card)] bg-[color:var(--bg-surface)] px-8 pb-8 pt-7">
          ...
          <button
            onClick={handleLogin}
            className="mt-5 flex w-full items-center justify-center gap-2 rounded-[var(--radius-control)] bg-[color:var(--ink)] px-6 py-3.5 text-base font-bold text-[color:var(--surface)] shadow-[0_14px_30px_rgba(23,23,19,0.16)] transition hover:bg-black focus:outline-none focus:ring-4 focus:ring-[#2a5bff]/15"
          >
