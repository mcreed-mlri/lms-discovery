...
export const plannedPaths: Path[] = [
  {
    ...
    title: "New Attorney",
    description:
      "Start here: the habits, ethics, and history every new legal aid advocate needs before taking a case.",
    courseIds: ["course-foundations", "course-ethics"],
    totalDuration: "Self-paced",
    level: "Foundations",
    availability: "planned",
  },
  {
    id: "path-access-to-counsel",
    title: "Access to Counsel",
    description:
      "How a client reaches you: referral, intake, and conflict checks before you open a file.",
    courseIds: ["course-pre-engagement"],
    totalDuration: "Self-paced",
    level: "Foundations",
    availability: "planned",
  },
  {
    id: "path-bridge-to-practice",
    title: "Bridge to Practice",
    description:
      "Turn what you know into what you can write and find: legal writing and legal research for real casework.",
    courseIds: ["course-legal-writing", "course-legal-research"],
    totalDuration: "Self-paced",
    level: "Intermediate",
    availability: "planned",
  },
  {
    id: "path-before-trial",
    title: "Before Trial",
    description: "Interview the client, investigate the facts, and build the theory of the case.",
    courseIds: ["course-pre-trial"],
    totalDuration: "Self-paced",
    level: "Intermediate",
    availability: "planned",
  },
  ...
  {
    id: "path-after-the-verdict",
    title: "After the Verdict",
    description: "Post-trial motions, preserving issues for appeal, and the appeal itself.",
    courseIds: ["course-post-trial", "course-appellate"],
    totalDuration: "Self-paced",
    level: "Advanced",
    availability: "planned",
  },
